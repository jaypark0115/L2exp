...
def build_standalone_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Standalone single-file runner for L1 Sensory/Sen 120k training and test."
    )
    parser.add_argument("--data-root", type=Path, default=default_snn_root(), help="Path to the original snn folder.")
    parser.add_argument("--results-root", type=Path, default=default_results_root())
    parser.add_argument("--run-name", default="server_run_l1_sen_rein_120k_001")
    parser.add_argument("--modes", nargs="+", default=["sen"], choices=["sen"])
